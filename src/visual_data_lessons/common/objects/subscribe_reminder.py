...
class SubscribeReminder(Group):
    def __init__(self, **kwargs):
        ...
        circle = Circle(radius=image.width / 2, color="#FF3B30", stroke_width=5)
        ...
        like_text = Text("", font_size=36, color="#1F1F1F")
        bell_text = Text("󰂜", font_size=36, color="#1F1F1F")
    ...
    def animate(self):
        ...
        new_like = Text("", font_size=36, color="#2563EB")
        ...
        return Succession(
            ...
            AnimationGroup(
                ...
                self.button_group[0].animate.set_color("#FF3B30"),
                lag_ratio=1,
                run_time=1.0,
            ),
            AnimationGroup(
